...
const Rentals = () => {
  ...
  const handleNoAccount = () => {
    dispatch({
      type: "error",
      message: "You need to connect your wallet to book rental",
      title: "Not Connected",
      position: "topL",
    });
  }
  ...
  const bookRental = async function (start, end, id, dayPrice) {
    ...
    let options = {
      contractAddress: "0xb49e4a464fa9f6E7c179a2834ff1fA76ac5a6B8D",
              ...
              return (
                <>
                  ...
                  <div className={highLight === i ? "rentalDivH" : "rentalDiv"}>
                    <img className="rentalImg" src={e.attributes.imgUrl} alt={e.attributes.name}></img>
